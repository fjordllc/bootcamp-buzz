...
さらに、X（旧Twitter）・はてなブックマーク・Google 検索で検索しながらバズを登録していくときは、**すでに登録済みの記事リンクに自動で「✓ 登録済み」の目印**が付くので、二重チェックを防げます（[6. X・はてなブックマーク・Google 検索で登録済みのリンクに印を付ける](#6-xはてなブックマークgoogle-検索で登録済みのリンクに印を付ける)）。
...
5. [使い方](#5-使い方)
6. [X・はてなブックマーク・Google 検索で登録済みのリンクに印を付ける](#6-xはてなブックマークgoogle-検索で登録済みのリンクに印を付ける)
